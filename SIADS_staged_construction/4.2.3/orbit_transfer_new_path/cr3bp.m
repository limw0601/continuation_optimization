...
dx(2,:) = x5+p.*dEdx2;
dx(3,:) = x6+p.*dEdx3;
dx(4,:) = x1+2*x5-(1-mu)*(x1+1+1/gama)./gama^3./d1.^3-mu*(x1+1)/gama^3./d2.^3+(1-mu+gama)/gama+p.*dEdx4;
dx(5,:) = x2-2*x4-(1-mu)/gama^3./d1.^3.*x2-mu./gama^3./d2.^3.*x2+p.*dEdx5;
dx(6,:) = -(1-mu)/gama^3./d1.^3.*x3-mu./gama^3./d2.^3.*x3+p.*dEdx6;
