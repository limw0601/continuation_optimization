...
[t0, x0]  = ode45(@(t,x) optcont(t, x, p0), [-1 1], 1);
coll_args = {@optcont, @optcont_dx, @optcont_dp, @optcont_dt, ...
  @optcont_dxdx, @optcont_dxdp, @optcont_dpdp, @optcont_dtdx, ...
  @optcont_dtdp, @optcont_dtdt, t0, x0, par_args, p0};
...
prob1 = coco_add_pars(prob1, 'mayer', uidx(maps.x1_idx), 'yf');
% adjoints
...
prob2 = coco_add_pars(prob2, 'mayer', uidx(maps.x1_idx), 'yf');
...
prob3 = coco_add_pars(prob3, 'mayer', uidx(maps.x1_idx), 'yf');
